...
#include "ros/ros.h"
#include <string>
#include <aerial_manipulators/PID.h>
#include <std_msgs/Float64.h>
#include <geometry_msgs/Vector3.h>
#include <sensor_msgs/JointState.h>
#include <rosgraph_msgs/Clock.h>
#include <dynamic_reconfigure/server.h>
#include <aerial_manipulators/JointCtlParamsConfig.h>

class JointControl
{
	private:
		void configCallback(aerial_manipulators::JointCtlParamsConfig &config, uint32_t level);
		float ref_;
		bool config_start_;
		PID joint_pid_;

		dynamic_reconfigure::Server<aerial_manipulators::JointCtlParamsConfig> *dr_srv;
		dynamic_reconfigure::Server<aerial_manipulators::JointCtlParamsConfig>::CallbackType cb;
	public:
		JointControl();
		~JointControl();
