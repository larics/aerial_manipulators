...
{
	dr_srv = new dynamic_reconfigure::Server<aerial_manipulators::JointCtlParamsConfig>(n);
...
void JointControl::configCallback(aerial_manipulators::JointCtlParamsConfig &config, uint32_t level)
{
